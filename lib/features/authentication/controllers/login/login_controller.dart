...
import 'package:fake_store_flutter/utils/local_storage/storage_utility.dart';
...
class LoginController extends GetxController {
  ...
  Future<void> emailAndPasswordSignIn() async {
    try {
      FullScreenLoader.openLoadingDialog('Effettuando il ligin...', MyImages.adidas);
      ...
      final userCredentials = await AuthenticationRepository.instance.loginWithEmailAncPassword(email.text.trim(), password.text.trim());
